...
<body class="bg-dark">
    <h1 class="bg-black" style="color: white;">VNBOOK - Toapanta Alan</h1>
    <br>
    <div class="container">
      <div class="row">
        <div class="col-md-6">
            <input type="text" id="pub_usuario" placeholder="Usuario" class="form-control">
            <textarea  id="pub_descripcion" rows="2" class="form-control" placeholder="Descripcion"></textarea>
    ...
    <div class="row">
        ...
        <div class="card cont_publicacion"  style="width: 30rem;">
              ...
              <div class="card-body">
                    <h3 id="estado" style="color: dark;">Estado</h3>
                <p class="card-text" id="publicacion" style="color: black;" >Descripcion</p>
            </div>
        </div>
        </div>
    </div>
